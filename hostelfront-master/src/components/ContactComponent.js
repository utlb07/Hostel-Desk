...
function Contact(props) {
    ...
    const handleSubmit = (event) => {
        ...
        window.open(`https://mail.google.com/mail/?view=cm&fs=1&to=aryanrajputsfe@gmail.com&su=${initialState.subject}&body=${message}`); event.preventDefault();
    }
        ...
        <div className="container-fluid contact">
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-md-4 offset-md-2">
                    ...
                    <a href="http://www.mnnit.ac.in/vcas2018/map/" target="_blank" rel="noreferrer noopener"><i className="fa fa-map-marker-alt fa-2x info"></i></a><div className="text"><p><strong>Location:</strong><br />Motilal Nehru National Institute of Technology, Prayagraj,<br />Allahabad, 211004</p></div>
                    <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=aryanrajputsfe@gmail.com" target="_blank" rel="noreferrer noopener"> <i className="fa fa-envelope fa-2x info"></i></a><div className="text"><p><strong>Email:</strong><br />deansw@mnnit.ac.in</p></div>
                    <a href="tel:91-0532-2545404" target="_blank" rel="noreferrer noopener"> <i className="fa fa-phone-alt fa-2x info"></i></a><div className="text"><p><strong>Call:</strong><br />91-0532-2545404</p></div>
                </div>
