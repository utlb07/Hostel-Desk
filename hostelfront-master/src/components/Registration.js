          ...
          <div className="row">
            <div className="form-group col-md-6">
              ...
              <input
                ...
                required
                pattern="[A-Z a-z ]+"//
                title="Name must not contain numeric values"//
                minLength="3"
                maxLength="20"
              />
            </div>
            <div className="form-group col-md-6">
              ...
              <input
                ...
                className="form-control"
                name="sid"
                placeholder="202xcaxxx"
                required
                pattern="^202[0-4]{1}ca[0-9]{3}$"//
                title="Registration No. must be in 2021caxxx format"//
                minLength="7"
                maxLength="9"
              />
            </div>
            ...
            <div className="form-group col-md-6">
              ...
              <input
                ...
                placeholder=""
                required
                title="Must be lengthen between 9 to 18 digits"
                minLength="9"
                maxLength="18"
              />
            </div>
            <div className="form-group col-md-6">
              ...
              <input
                ...
                placeholder=""
                required
                title="Allows only 11 digits IFSC Code"
                minLength="11"
                maxLength="11"
              />
            </div>
