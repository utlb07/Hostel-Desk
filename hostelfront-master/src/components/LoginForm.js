...

                {
                    <CardBody>
                        <Form className="myForm" onSubmit={handleLoginClick}>
                            <FormGroup>
                                <Label htmlFor="username" ><h6>Registration No.</h6></Label>
                            ...
                            <button type="submit" value="submit" className="btn btn-secondary btn-md btn-block mt-2" ><span className="fa fa-sign-in-alt fa-lg"></span>Login</button>
                        </Form>
                    </CardBody>}
